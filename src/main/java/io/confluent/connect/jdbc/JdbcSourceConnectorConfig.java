...
public class JdbcSourceConnectorConfig extends AbstractConfig {
  ...
  private static class TableRecommender implements Recommender {
    ...
    public List<Object> validValues(String name, Map<String, String> props) {
      JdbcSourceConnectorConfig config = new JdbcSourceConnectorConfig(props, false, false);
      String dbUrl = config.getString(CONNECTION_URL_CONFIG);
      Connection db;
      try {
  ...
  private static class ModeDependentsRecommender implements Recommender {
    ...
    public boolean visible(String name, Map<String, String> props) {
      JdbcSourceConnectorConfig config = new JdbcSourceConnectorConfig(props, false, false);
      String mode = config.getString(MODE_CONFIG);
      switch (mode) {
        case MODE_BULK:
          return false;
        case MODE_TIMESTAMP:
  ...
  private JdbcSourceConnectorConfig(Map<String, String> props, boolean doLog, boolean checkRequired) {
    super(config, props, doLog, checkRequired);
  }
